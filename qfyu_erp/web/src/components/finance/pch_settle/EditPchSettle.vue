...
<script>
    ...
    export default {
       ...
       data(){
         return {
            height:0,
            Breadcrumb:[{title:'财务管理'},{title:'采购结算单查询',url:'PchSettleList'},{title:'采购结算单'}]
