<template>
  <Modal v-model="show_self" title="选择线路" width="1080" footer-hide :mask-closable="false">
      <div class="seldeliv-out">
        <div class="sel-vmiddle">
          <div class="selcustw bg">
            ...
            <div class="selcust-foot">
              ...
              <div class="serleft">
                <Input v-model="params.keyword" placeholder="线路名/车牌/司机/跟车人，支持模糊搜索" @on-enter="init()">
    ...
    export default{
        ...
        data(){
          return{
            ...
            table_loading:true,
            columns: [
              {title:'ID',key:'id',width:50,resizable:true,ellipsis :true},
              {title:'线路名称',key:'dname',width:218,resizable:true,ellipsis :true},
              {title:'车牌号',key:'licpla',width:150,resizable:true,ellipsis :true},
              {title:'司机',key:'driver',width:130,resizable:true,ellipsis :true},
              {title:'发车时间',key:'send_time',width:100,resizable:true,ellipsis :true},
              {title:'跟车人',key:'sttimeman',width:130,resizable:true,ellipsis :true},
              {title:'备注',key:'remark',width:260,resizable:true,ellipsis :true}
            ],
            data:{}
          }
        },
        methods:{
            init:function(params){
              ...
              if(typeof(params)!="undefined"){
                ...
                _this.common.http({url:'selectDelivery',data:_this.params}).then(function(res){
          ...
          sure_cust:function () {
            if(this.sel_key==-1){
              this.alertMsg('请选择线路！','error');return false;
            }
            this.$emit('seldeliv',{data:this.data.data[this.sel_key],set_key:this.set_key});
           ...
           */
          clear_sel:function () {
            this.$emit('clear_sel',this.set_key);
            this.show_self=false;
          }
        }
    }
...
<style lang="less">
  .seldeliv-out{display: table; width: 100%; height: 100%;
    .sel-vmiddle{
