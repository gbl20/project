<template>
	<div class="main">
    <Modal title="【销退】质量验收默认设置" v-model="modal" width="650">
      ...
      <div slot="footer">
        <Button><span class="icon iconfont">&#xe792;</span>保存设置</Button>
        <Button><span class="icon iconfont">&#xe693;</span>还原设置</Button>
        <Button @click="close"><span class="icon iconfont">&#xe68f;</span>关闭</Button>
      </div>
    </Modal>
...
<script>
  ...
  import SelectEmployee from "@/components/common/SelectEmployee"
    ...
    methods:{
      ...
      close(){
		    this.modal = false;
		    this.delView('QualityAcceptDefault');
      }
    }
	}
</script>
